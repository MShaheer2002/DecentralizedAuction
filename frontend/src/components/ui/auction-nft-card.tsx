            ...
            <div className="relative overflow-hidden">
                <div className="w-full h-[300px] bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center border-b border-green-500/10 relative">
                    ...
                    <div className="absolute top-4 left-4 right-4 flex justify-between items-center">
                        {/* Status Badge */}
                        <div
                            className={`px-3 py-1 rounded-full text-xs font-bold backdrop-blur-sm border transition-all duration-300 ${isAuctionActive
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/40 rounded-xl p-4 border border-gray-700/50 hover:border-green-500/30 transition-all duration-300 group/bid">
                        ...
                        <div className="flex items-baseline gap-1">
                            <span className="text-white text-2xl font-bold">{highestBid}</span>
                            <span className="text-green-400 text-sm font-bold">{currency}</span>
                        </div>
                        <div className="text-gray-500 text-xs mt-1">≈ ${(highestBid * 2000).toLocaleString()} USD</div>
                    </div>
                ...
                <div className="bg-gradient-to-r from-gray-800/40 to-green-900/20 rounded-xl p-4 border border-green-500/20">
                    <div className="flex items-center justify-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-r from-green-400 to-green-600 rounded-xl flex items-center justify-center">
                            <Clock className={`w-5 h-5 text-black ${isAuctionActive ? "animate-pulse" : ""}`} />
                        </div>
                        <div className="text-center">
                            <div className="text-gray-300 font-semibold text-sm mb-1">
                                {isAuctionActive ? "Ends in:" : "Auction ended"}
                            </div>
                            <div className={`font-bold text-xl ${isAuctionActive ? "text-white" : "text-red-400"}`}>
                                {isAuctionActive ? timeLeft : "⏰ Time's up!"}
                            </div>
                        </div>
                    </div>
                </div>
